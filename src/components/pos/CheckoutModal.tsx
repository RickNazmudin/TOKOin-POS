...
interface CheckoutModalProps {
  ...
  total: number;
  itemCount: number;
  onConfirmPayment: (paymentMethod: "CASH" | "QRIS", paidAmount: number) => void;
...
export default function CheckoutModal({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onConfirmPayment(paymentMethod, paymentMethod === "QRIS" ? total : paidAmount);
  };
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in overflow-y-auto">
      <div className="bg-white rounded-3xl shadow-2xl border border-slate-200 max-w-lg w-full my-6 overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          {/* Big Total Banner */}
          <div className="bg-slate-900 rounded-2xl p-5 text-white text-center shadow-lg relative overflow-hidden">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-slate-50 border-2 border-slate-300 rounded-xl text-xl font-black text-slate-900 focus:outline-none focus:border-emerald-600 focus:bg-white transition"
                />
              </div>
          ...
          <div className="pt-3 border-t border-slate-100 flex items-center gap-3">
            ...
            <button
              ...
              className="flex-1 py-3 px-6 bg-emerald-600 hover:bg-emerald-700 disabled:opacity-50 text-white text-sm font-black rounded-xl transition shadow-lg shadow-emerald-600/30 flex items-center justify-center gap-2 cursor-pointer"
            >
              {isProcessing ? (
                <>
                ...
                <>
                  ...
                  <span>Selesaikan & Bayar (Enter)</span>
                </>
              )}
            </button>
          </div>
